#!/usr/bin/env python3
"""Delete the 12 specific check-ins that are blocking the test."""
...
# The exact 12 plan_item_ids from the error messages
conflicting_ids = [
...
print("🗑️  Deleting 12 conflicting check-ins...")

result = supabase.table('task_checkins').delete().eq(
    'profile_id', 'a57f70b4-d0a4-4aef-b721-a4b526f64869'
).in_('plan_item_id', conflicting_ids).eq(
    'planned_date', '2025-10-29'
).execute()

print("✅ Deleted! Now press Enter in the test to continue.")
